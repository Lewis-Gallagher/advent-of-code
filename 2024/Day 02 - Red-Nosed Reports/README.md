# Advent of Code 2024 - Day 02 - Python3
## Red-Nosed Reports
...
<p>Analyze the unusual data from the engineers. <em>How many reports are safe?</em>

# Part 2 ⭐️⭐️

The engineers are surprised by the low number of safe reports until they realize they forgot to tell you about the <span title="I need to get one of these!">Problem Dampener</span>.</p>
...
<p>Update your analysis by handling situations where the Problem Dampener can remove a single level from unsafe reports. <em>How many reports are now safe?</em>
