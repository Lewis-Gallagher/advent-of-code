# Advent of Code 2022 - Day 2 - Python3
## Rock Paper Scissors
...
# Part 2 ⭐️⭐️
The Elf finishes helping with the tent and sneaks back over to you. "Anyway, the second column says how the round needs to end: <code>X</code> means you need to lose, <code>Y</code> means you need to end the round in a draw, and <code>Z</code> means you need to win. Good luck!"</p>
...
<p>Your puzzle answer was <code>12382</code>.</p>
